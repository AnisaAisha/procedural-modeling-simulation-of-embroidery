...
HIGH_ARCH_MAX = 0.45 * SQUARE_SIZE      # peak height of the very first stitch (7.5)
...
WOBBLE_AMP = 0.5     # z-offset amplitude while the stitch is still loose
WOBBLE_FREQ = 5.0     # spatial wobble frequency along the stitch (in h)
...
def phong_shading(p, n, t):
    ...
    lightPos = tm.vec3(3.0, 30.0, -20.0)
