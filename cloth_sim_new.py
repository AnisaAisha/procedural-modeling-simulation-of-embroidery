...
def init_springs_state():
    ...
    # We populate the springs list linearly
    s_list = []
...
# =============================================================================
@ti.kernel
def update_mesh(h_scale: ti.f32, detail_strength: ti.f32):
    ...
    # Pass 2: Calculate accurate dynamic TBN blended normals
    for i, j in ti.ndrange(GRID_ROWS, GRID_COLS):
        idx = i * GRID_COLS + j
        u = j / (GRID_COLS - 1)
        v = i / (GRID_ROWS - 1)
        ...
        # Micro-detail normals from the map
